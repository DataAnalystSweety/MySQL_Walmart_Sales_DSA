...
2. **Data Mining:** This will help use generate some new columns from existing ones.
...
9. Fetch each product line and add a column to those product line showing "Good" if its greater than average sales else "Bad".
...
3. Which customer type gave the highest sales?
4. Which gender gave the highest sales?
5. What is the customer distribution by gender per branch?
6. Which time of the day do customers give most ratings?
7. Which branch gets best average rating?
